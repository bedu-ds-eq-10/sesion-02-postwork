...
graphic <- ggplot(iris, aes(x = Sepal.Length, y=Sepal.Width, color = Species, size = Petal.Width)) + 
...
graphic <- graphic + geom_point(data = iris_mean, shape = 23, size = 4, fill = "black", stroke = 2) +
